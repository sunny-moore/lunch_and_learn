...
RSpec.describe 'Country Facade' do
  context 'Happy Path' do
    xit 'gets a list of countries with a given name and returns one', vcr: 'one_country_facade' do
    ...
    xit 'can return a random country from a country list', vcr: 'random_country_facade' do
